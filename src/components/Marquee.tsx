...
export default function Marquee() {
  ...
  return (
    <section className="py-20 md:py-32 overflow-hidden border-y border-white/5 bg-white/5 backdrop-blur-sm relative z-20">
      <div 
        ref={containerRef}
        className="w-[200%] flex whitespace-nowrap marquee-content"
      >
        <div className="flex w-1/2 justify-around items-center gap-8 md:gap-16 px-4 md:px-8">
